    ...
    public partial class FrmClientes : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (ClienteModificar == true)
            {
                ...
                DeshabilitaBotones();
                MessageBox.Show("Su Cliente/Inquilino se modificó existosamente", "Mensaje nfomativo", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void cbxLoclidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //if (cbxLoclidad.SelectedIndex > 0)
            //{
        ...
        private void dtGridClientes_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
...

            {
                ...
                Clase_Clientes.IntiDCliente = int.Parse(dtGridClientes.Rows[e.RowIndex].Cells[0].Value.ToString());
